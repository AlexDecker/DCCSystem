...
classdef FFGreedy < FeasibleFuture
    ...
    methods
        function obj = FFGreedy(hashSize, nSegments, maxSize, ttl, nt, nr)
        ...
        function [final, new] = newFeasibleFuture(obj, initialSet, timeSlot, dt,...
			...
			while attempts < obj.ttl && ~threshold_reached
				...
				if minK + FFGreedy.tolerance <= maxK - FFGreedy.tolerance
					...
					V = (maxK - FFGreedy.tolerance)*v_base;
					I = (maxK - FFGreedy.tolerance)*i_base;

					Q = FFGreedy.integrateCharge(Q0,I,timeSlot.Id,deviceData,dt,chargeData);
						
					if FFGreedy.verbose_down
						print_vector('K', maxK - FFGreedy.tolerance, 2);
						print_vector('V', V, 2);
            ...
            %build the object
            new = FFGreedy(obj.hashSize, obj.nSegments, obj.maxSize, obj.ttl, obj.nt, obj.nr);
        ...
        function initial = generateInitialSet(obj, chargeData)
            ...
            %build the object
            initial = FFGreedy(1, obj.nSegments, 1, obj.ttl, obj.nt, obj.nr);
