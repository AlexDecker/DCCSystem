...
for i=0:n_files-1
	...
	ffModel = FFDoubleDummie(result.hashSize, result.nSegments, 10000, 250, inf, inf,...
		750, 20, 20, result.nt, result.nr); 
	...
	save([folder,'\output_double', sufix, num2str(i),'.mat'], 'output');
