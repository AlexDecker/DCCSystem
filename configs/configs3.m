function genSettings = configs1()
    ...
    genSettings.R = 0.05*ones(9,1);%RLCs resistance
    genSettings.C = -1*ones(9,1);%RLC's capacitance (-1=use data from .mat)
    genSettings.MAX_ACT_POWER = 600;%W
    genSettings.MAX_APP_POWER = inf;%60000;%W
    genSettings.TOTAL_TIME = 18000000;%18000;%seconds of simulation (virtual time)=5h
    ...
    genSettings.envFolder = 'mobData3';%the folder containing the envList files
end
